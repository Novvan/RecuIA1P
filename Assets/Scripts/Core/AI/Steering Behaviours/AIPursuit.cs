...
{
    public class AIPursuit : ISteering
    {
        ...
        public AIPursuit(Transform self, Transform target, IVel vel, float timePrediction)
        {
            _self = self;
            _target = target;
            _vel = vel;
        ...
        public Vector3 GetDir()
        {
            ...
            var direction = (finalPosition - _self.position).normalized;
